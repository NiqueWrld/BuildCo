...
public class ItemsDomain implements Serializable {
    ...
    public ItemsDomain(String title, String description, ArrayList<String> picUrl, double price, double oldPrice, double review , double rating, double numberInCart) {
        this.title = title;
